...
export default class Edit extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      title: this.props.navigation.state.params.itemTitle,
      description: this.props.navigation.state.params.itemDescription.toString(),
      price: this.props.navigation.state.params.itemPrice.toString(),
      user: '',
    };
  ...
  confirmDelete() {
    Alert.alert(
        ...
        '',
        [
          {text: 'OK', onPress: () => this.deletePosting()},
          {text: 'Cancel', onPress: () => {}},
    ...
    return (
        <KeyboardAwareScrollView
          ...
          <View>
            ...
            <TouchableOpacity onPress={() => this.confirmDelete()} style={styles.buttonContainer}>
